...
mysql -uroot -proot --local-infile=1 sample -e "LOAD DATA LOCAL INFILE '/docker-entrypoint-initdb.d/sample.csv' INTO TABLE sample FIELDS TERMINATED BY ',' ENCLOSED BY '\"' LINES TERMINATED BY '\n' (a, b, c, d, e, f, g, h, i, j)"
